...
const DEFAULT_BOARDS = [
  ...
  { slug: 'gratitude', title: '오늘 감사했던 일 3가지', category: '감정 · 마음', tag: '감사일기',
    description: '오늘 있었던 작은 감사한 일 세 가지를 적어보세요.', hidden: false, order: 4 },
  { slug: 'self-praise', title: '오늘 나를 칭찬하기', category: '감정 · 마음', tag: '칭찬',
    description: '아무리 사소해도 괜찮아요. 오늘 해낸 나를 칭찬해주세요.', hidden: false, order: 5 },
  { slug: 'anonymous-worry', title: '익명 고민방', category: '감정 · 마음', tag: '공감만',
    description: '조언보다는 공감과 응원만 남겨주세요. 함께 들어드릴게요.', hidden: false, order: 6 },
  ...
  { slug: 'transcription', title: '필사 게시판', category: '감각 · 속도 늦추기', tag: '필사',
    description: '마음에 남았던 문장을 손글씨나 타이핑으로 따라 적어보세요.', hidden: false, order: 6 },
  { slug: 'digital-detox', title: '디지털 디톡스 인증', category: '감각 · 속도 늦추기', tag: '디톡스',
    description: '오늘 스마트폰 대신 한 일을 기록해보세요.', hidden: false, order: 7 },
  { slug: 'slow-routine', title: '느린 하루 루틴 공유', category: '감각 · 속도 늦추기', tag: '루틴',
    description: '명상, 산책, 차 마시기 등 나만의 힐링 루틴을 나눠보세요.', hidden: false, order: 8 },
  { slug: 'small-kindness', title: '오늘 누군가에게 받은 작은 친절', category: '연결 · 온기', tag: '소확행',
    description: '오늘 받은 작은 친절, 잊기 전에 남겨보세요.', hidden: false, order: 1 },
  { slug: 'playlist', title: '힐링 플레이리스트·추천', category: '연결 · 온기', tag: '취향 공유',
    description: '요즘 듣는 노래, 마시는 차, 먹는 음식을 추천해주세요.', hidden: false, order: 2 },
  { slug: 'goodnight', title: '잠들기 전 인사', category: '연결 · 온기', tag: '굿나잇',
    description: '오늘 하루도 고생한 서로에게 인사를 건네보세요.', hidden: false, order: 3 },
];
